/***************************************************************************//**
 * @file     fmc_user.c
 * @brief    M071R_M071S series FMC driver source file
 * @version  2.0.0
 *
...
{
    // For M071R_M071S series, CONIFG2 must be 0xFFFFFF5A (Don't modify this value. It should be 0xFFFFFF5A after reset.)
